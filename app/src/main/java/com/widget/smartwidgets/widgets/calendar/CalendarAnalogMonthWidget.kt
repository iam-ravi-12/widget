...
class CalendarAnalogMonthWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = CalendarAnalogMonthWidget()
...
class CalendarAnalogMonthWidget : GlanceAppWidget() {
                ...
                GlanceWidgetCard(
                    ...
                    Row(
                        ...
                        Box(
                            ...
                            val remoteViews = RemoteViews(context.packageName, R.layout.widget_analog_clock_calendar)
                            AndroidRemoteViews(
